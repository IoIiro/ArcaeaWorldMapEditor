...
namespace ArcaeaWorldMapEditor
{
    public static class GameData
    {
        ...
        {
            public const string Fragment50 = "frag50";
            public const string LowLevel = "lowlevel";
            public const string Over100Step50 = "over100_step50";
            public const string Antiheroism = "antiheroism";

            public static readonly HashSet<string> DisableOverLaws = new()
            {
                Over100Step50,
                Antiheroism
            };
